...
_domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayProjects(projectsArr);
_domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayTasks(tasksArr);
...
const createTask = (e) => {
    ...
    let dueDate = document.getElementById('due').value === '' ? '' : (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(document.getElementById('due').value), 'yyyy-MM-dd');
...
function switchProject(e) {
    ...
    if (projectClicked == 'All Tasks') {
        ...
        _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayTasks(tasksArr.filter(t => t.project == projectClicked));
