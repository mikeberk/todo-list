...
const createTask = (e) => {
    ...
    //return newTask;
    // want to add task to task array or project array and then re-render the dom
    //contentContainer.appendChild(domStuff.addTaskToDOM(newTask));
    _domRender__WEBPACK_IMPORTED_MODULE_2__.domRender.displayTask(newTask);
    form.reset();
}
