...
const deleteTask = (e) => {
    ...
    // use the project built-in to remove task matching the dataset value or create function to remove it from the remaining proj array
    // find project
}
