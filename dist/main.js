...
/* harmony import */ var _domRender__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./domRender */ "./src/domRender.js");
...
const domStuff = (() => {
    ...
    const deleteProject = (e) => {
        ...
        let tasksArr = [];
        tasksArr.push(..._globals__WEBPACK_IMPORTED_MODULE_0__.globalVars.getTasks());
        let filteredTasks = tasksArr.filter(t => t.project == projectToDelete);
        for (let i = 0; i < filteredTasks.length; i++) {
            filteredTasks[i].project = '';
        }
        _globals__WEBPACK_IMPORTED_MODULE_0__.globalVars.setTasks(tasksArr);

        let projectsArr = [];
        projectsArr.push(..._globals__WEBPACK_IMPORTED_MODULE_0__.globalVars.getProjects());
        let projectsIndex = projectsArr.indexOf(projectToDelete);
        projectsArr.splice(projectsIndex, 1);
        _globals__WEBPACK_IMPORTED_MODULE_0__.globalVars.setProjects(projectsArr);
        _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayProjects(_globals__WEBPACK_IMPORTED_MODULE_0__.globalVars.getProjects());
        if (_globals__WEBPACK_IMPORTED_MODULE_0__.globalVars.currentDisplay == projectToDelete) {
            let tasks = [];
            tasks.push(..._globals__WEBPACK_IMPORTED_MODULE_0__.globalVars.getTasks());
            _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayTasks(tasks.sort((a, b) => a.taskAdded - b.taskAdded));
            _globals__WEBPACK_IMPORTED_MODULE_0__.globalVars.currentDisplay = 'default';
    ...
    const addTaskToDOM = (task) => {
        ...
        taskStatus.addEventListener('change', (e) => {
            ...
            _globals__WEBPACK_IMPORTED_MODULE_0__.globalVars.setTasks(tasks);
        })
    ...
    const deleteTask = (e) => {
        ...
        let updatedTasks = [];
        updatedTasks.push(..._globals__WEBPACK_IMPORTED_MODULE_0__.globalVars.getTasks());
        let taskIndex = updatedTasks.map(e => e.title).indexOf(taskName);
        updatedTasks.splice(taskIndex, 1);
        _globals__WEBPACK_IMPORTED_MODULE_0__.globalVars.setTasks(updatedTasks);

        let newTasksArr = [];
        newTasksArr.push(..._globals__WEBPACK_IMPORTED_MODULE_0__.globalVars.getTasks());
        if (_globals__WEBPACK_IMPORTED_MODULE_0__.globalVars.currentDisplay !== 'default') {
            let currentProjectTasks = newTasksArr.filter(task => task.project == _globals__WEBPACK_IMPORTED_MODULE_0__.globalVars.currentDisplay);
            _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayTasks(currentProjectTasks);
        } else {
            let sortedTasks = newTasksArr.sort((a, b) => a.taskAdded - b.taskAdded);
            _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayTasks(sortedTasks);
        }
    ...
    const editTask = (e) => {
        ...
        e.target.addEventListener('click', (e) => {
            ...
            if (task.project !== projectInput.value) {
                let projectsArr = [..._globals__WEBPACK_IMPORTED_MODULE_0__.globalVars.getProjects()];
                if (!projectsArr.includes(projectInput.value)) {
                    let updatedProjects = [..._globals__WEBPACK_IMPORTED_MODULE_0__.globalVars.getProjects()]
                    updatedProjects.push(projectInput.value);
                    _globals__WEBPACK_IMPORTED_MODULE_0__.globalVars.setProjects(updatedProjects);
                }
                _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayProjects(_globals__WEBPACK_IMPORTED_MODULE_0__.globalVars.getProjects());
                const projects = document.querySelectorAll('.project-name')
                projects.forEach(proj => proj.addEventListener('click', switchProject));
    ...
    const switchProject = (e) => {
        ...
        if (projectClicked == 'All Tasks') {
            ...
            _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayTasks(filteredTasks);
            _globals__WEBPACK_IMPORTED_MODULE_0__.globalVars.currentDisplay = projectClicked;
...
/* harmony export */ });
/* harmony import */ var _domContoller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./domContoller */ "./src/domContoller.js");
...
const domRender = (() => {
    ...
    const displayProjects = (projects) => {
        ...
        projects.forEach(p => sideBarContainer.appendChild(_domContoller__WEBPACK_IMPORTED_MODULE_0__.domStuff.addProjectToDOM(p)));
    }
    ...
    const displayTasks = (tasks) => {
        ...
        tasks.forEach(task => contentContainer.appendChild(_domContoller__WEBPACK_IMPORTED_MODULE_0__.domStuff.addTaskToDOM(task)));
...
const globalVars = (() => {
    const getTasks = () => {
        ...
        for (let element of taskObjects) {
            let task = new _constructors__WEBPACK_IMPORTED_MODULE_0__.Task(element.title, element.description, element.dueDate, element.priority, element.project, element.completed, element.taskAdded);
            tasksArr.push(task);
        };
        return tasksArr;
    }
...
/* harmony import */ var _domRender__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./domRender */ "./src/domRender.js");
/* harmony import */ var _domContoller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./domContoller */ "./src/domContoller.js");
...
// static test
let taskOne = new _constructors__WEBPACK_IMPORTED_MODULE_0__.Task('Go To Gym', '1 hour exercise', '', 'high', 'exercise', false);

let updatedTasks = [];
updatedTasks.push(taskOne);
_globals__WEBPACK_IMPORTED_MODULE_3__.globalVars.setTasks(updatedTasks);

let updatedProjects = [];
updatedProjects.push('exercise');
_globals__WEBPACK_IMPORTED_MODULE_3__.globalVars.setProjects(updatedProjects);

_domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayProjects([..._globals__WEBPACK_IMPORTED_MODULE_3__.globalVars.getProjects()]);
_domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayTasks([..._globals__WEBPACK_IMPORTED_MODULE_3__.globalVars.getTasks()]);
const deleteBtns = document.querySelectorAll(".delete-btn");
deleteBtns.forEach(btn => btn.addEventListener('click', _domContoller__WEBPACK_IMPORTED_MODULE_2__.domStuff.deleteTask));

const editBtns = document.querySelectorAll(".edit-btn");
editBtns.forEach(btn => btn.addEventListener('click', _domContoller__WEBPACK_IMPORTED_MODULE_2__.domStuff.editTask));
...
const createTask = (e) => {
    ...
    let dueDate = document.getElementById('due').value === '' ? '' : (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(document.getElementById('due').value), 'yyyy-MM-dd');
    let priority = document.getElementById('priority').value;
    let project = document.getElementById('project').value;

    let newTask = new _constructors__WEBPACK_IMPORTED_MODULE_0__.Task(title, description, dueDate, priority, project, completed);
    if (project) {
        if (!_globals__WEBPACK_IMPORTED_MODULE_3__.globalVars.getProjects().includes(project)) {
            let projectsArr = []
            projectsArr.push(..._globals__WEBPACK_IMPORTED_MODULE_3__.globalVars.getProjects());
            projectsArr.push(project);
            _globals__WEBPACK_IMPORTED_MODULE_3__.globalVars.setProjects(projectsArr);
        }
        _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayProjects([..._globals__WEBPACK_IMPORTED_MODULE_3__.globalVars.getProjects()]);
    } 
    let updatedTasks = []
    updatedTasks.push(..._globals__WEBPACK_IMPORTED_MODULE_3__.globalVars.getTasks())
    updatedTasks.push(newTask);
    _globals__WEBPACK_IMPORTED_MODULE_3__.globalVars.setTasks(updatedTasks);

    if (project) {
        let tasksArr = [];
        tasksArr.push(..._globals__WEBPACK_IMPORTED_MODULE_3__.globalVars.getTasks())
        let currentProjectTasks = tasksArr.filter(task => task.project == project);
        _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayTasks(currentProjectTasks);
        _globals__WEBPACK_IMPORTED_MODULE_3__.globalVars.currentDisplay = project;
        ...
        let sortedTasks = tasksArr.sort((a, b) => a.taskAdded - b.taskAdded);
        _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayTasks(sortedTasks);
        _globals__WEBPACK_IMPORTED_MODULE_3__.globalVars.currentDisplay = 'default';
        projectHeader.textContent = 'All Tasks';
    }
    const deleteBtns = document.querySelectorAll(".delete-btn");
    deleteBtns.forEach(btn => btn.addEventListener('click', _domContoller__WEBPACK_IMPORTED_MODULE_2__.domStuff.deleteTask));
    ...
    toggleForm();
    const projects = document.querySelectorAll('.project-name');
    projects.forEach(proj => proj.addEventListener('click', _domContoller__WEBPACK_IMPORTED_MODULE_2__.domStuff.switchProject));
}

newTaskForm.addEventListener('submit', createTask);

function toggleForm() {
    if (_globals__WEBPACK_IMPORTED_MODULE_3__.globalVars.currentDisplay !== 'default') {
        document.getElementById('project').value = _globals__WEBPACK_IMPORTED_MODULE_3__.globalVars.currentDisplay;
    } else {
        document.getElementById('project').value = '';
    }
    _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.toggleForm(powerball);
    _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.toggleForm(newTaskDiv);
}
