...
const domStuff = (() => {
    ...
    const deleteProject = (e) => {
        ...
        let filteredTasks = _globals__WEBPACK_IMPORTED_MODULE_0__["default"].tasksArr.filter(t => t.project == projectToDelete);
        for (let i = 0; i < filteredTasks.length; i++) {
            filteredTasks[i].project = '';
        }
        let projectsIndex = _globals__WEBPACK_IMPORTED_MODULE_0__["default"].projectsArr.indexOf(projectToDelete);
        _globals__WEBPACK_IMPORTED_MODULE_0__["default"].projectsArr.splice(projectsIndex, 1);
        _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayProjects(_globals__WEBPACK_IMPORTED_MODULE_0__["default"].projectsArr);
        if (_globals__WEBPACK_IMPORTED_MODULE_0__["default"].currentDisplay == projectToDelete) {
            _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayTasks(_globals__WEBPACK_IMPORTED_MODULE_0__["default"].tasksArr.sort((a, b) => a.taskAdded - b.taskAdded));
        }
...
*/
    const deleteTask = (e) => {
        ...
        let taskIndex = _globals__WEBPACK_IMPORTED_MODULE_0__["default"].tasksArr.map(e => e.title).indexOf(taskName);
        _globals__WEBPACK_IMPORTED_MODULE_0__["default"].tasksArr.splice(taskIndex, 1);

        if (_globals__WEBPACK_IMPORTED_MODULE_0__["default"].currentDisplay !== 'default') {
            let currentProjectTasks = _globals__WEBPACK_IMPORTED_MODULE_0__["default"].tasksArr.filter(task => task.project == _globals__WEBPACK_IMPORTED_MODULE_0__["default"].currentDisplay);
            _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayTasks(currentProjectTasks);
        } else {
            _globals__WEBPACK_IMPORTED_MODULE_0__["default"].tasksArr.sort((a, b) => a.taskAdded - b.taskAdded);
            _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayTasks(_globals__WEBPACK_IMPORTED_MODULE_0__["default"].tasksArr);
        }
    ...
    const editTask = (e) => {
        ...
        let taskIndex = _globals__WEBPACK_IMPORTED_MODULE_0__["default"].tasksArr.map(e => e.title).indexOf(taskName);
        let task = _globals__WEBPACK_IMPORTED_MODULE_0__["default"].tasksArr[taskIndex];
        ...
        e.target.addEventListener('click', (e) => {
            ...
            if (task.project !== projectInput.value) {
                if (!_globals__WEBPACK_IMPORTED_MODULE_0__["default"].projectsArr.includes(projectInput.value)) {
                    _globals__WEBPACK_IMPORTED_MODULE_0__["default"].projectsArr.push(projectInput.value);
                }
                _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayProjects(_globals__WEBPACK_IMPORTED_MODULE_0__["default"].projectsArr);
                const projects = document.querySelectorAll('.project-name')
                projects.forEach(proj => proj.addEventListener('click', switchProject));
    ...
    const switchProject = (e) => {
        ...
        if (projectClicked == 'All Tasks') {
            _globals__WEBPACK_IMPORTED_MODULE_0__["default"].tasksArr.sort((a, b) => a.taskAdded - b.taskAdded);
            _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayTasks(_globals__WEBPACK_IMPORTED_MODULE_0__["default"].tasksArr);
            _globals__WEBPACK_IMPORTED_MODULE_0__["default"].currentDisplay = 'default';
        } else {
            _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayTasks(_globals__WEBPACK_IMPORTED_MODULE_0__["default"].tasksArr.filter(t => t.project == projectClicked));
            _globals__WEBPACK_IMPORTED_MODULE_0__["default"].currentDisplay = projectClicked;
        }
...
_globals__WEBPACK_IMPORTED_MODULE_3__["default"].tasksArr.push(taskOne);
_globals__WEBPACK_IMPORTED_MODULE_3__["default"].projectsArr.push('exercise');
_domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayProjects(_globals__WEBPACK_IMPORTED_MODULE_3__["default"].projectsArr);
_domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayTasks(_globals__WEBPACK_IMPORTED_MODULE_3__["default"].tasksArr);
const deleteBtns = document.querySelectorAll(".delete-btn");
...
const createTask = (e) => {
    ...
    if (project) {
        if (!_globals__WEBPACK_IMPORTED_MODULE_3__["default"].projectsArr.includes(project)) {
            _globals__WEBPACK_IMPORTED_MODULE_3__["default"].projectsArr.push(project);
        }
        _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayProjects(_globals__WEBPACK_IMPORTED_MODULE_3__["default"].projectsArr);
    } 
    _globals__WEBPACK_IMPORTED_MODULE_3__["default"].tasksArr.push(newTask);

    if (project) {
        let currentProjectTasks = _globals__WEBPACK_IMPORTED_MODULE_3__["default"].tasksArr.filter(task => task.project == project);
        _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayTasks(currentProjectTasks);
        _globals__WEBPACK_IMPORTED_MODULE_3__["default"].currentDisplay = project;
    } else {
        _globals__WEBPACK_IMPORTED_MODULE_3__["default"].tasksArr.sort((a, b) => a.taskAdded - b.taskAdded);
        _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayTasks(_globals__WEBPACK_IMPORTED_MODULE_3__["default"].tasksArr);
        _globals__WEBPACK_IMPORTED_MODULE_3__["default"].currentDisplay = 'default';
    }
    const deleteBtns = document.querySelectorAll(".delete-btn");
    deleteBtns.forEach(btn => btn.addEventListener('click', _domContoller__WEBPACK_IMPORTED_MODULE_2__.domStuff.deleteTask));
...
function toggleForm() {
    if (_globals__WEBPACK_IMPORTED_MODULE_3__["default"].currentDisplay !== 'default') {
        document.getElementById('project').value = _globals__WEBPACK_IMPORTED_MODULE_3__["default"].currentDisplay;
    } else {
...
function switchProject(e) {
    ...
    if (projectClicked == 'All Tasks') {
        ...
        _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayTasks(_globals__WEBPACK_IMPORTED_MODULE_3__["default"].tasksArr.filter(t => t.project == projectClicked));
        _globals__WEBPACK_IMPORTED_MODULE_3__["default"].currentDisplay = projectClicked;
    }
