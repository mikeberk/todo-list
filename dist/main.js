...
const domRender = (() => {
    const displayTask = (task) => {
        contentContainer.appendChild(_domContoller__WEBPACK_IMPORTED_MODULE_0__.domStuff.addTaskToDOM(task));
    }
    ...
    const displayProject = (project) => {
        ...
        project.tasks.forEach(task => contentContainer.appendChild(_domContoller__WEBPACK_IMPORTED_MODULE_0__.domStuff.addTaskToDOM(task)));
    }
    ...
    const displayEditForm = (task, proj, container) => {
        ...
        container.appendChild(_domContoller__WEBPACK_IMPORTED_MODULE_0__.domStuff.createEditForm(task, proj));
    }
...
// static test
let taskOne = _domContoller__WEBPACK_IMPORTED_MODULE_0__.domStuff.addTaskToDOM(new _constructors__WEBPACK_IMPORTED_MODULE_1__.Task('Go To Gym', '1 hour exercise', '8/24/2022', 'high', true));
...
const deleteTask = (e) => {
    ...
    if (remIndex > -1) {
        ...
        _domRender__WEBPACK_IMPORTED_MODULE_2__.domRender.displayAllTasks(allTasks);
    } else {
        for (let key of Object.keys(projects)) {
           ...
           if (projects[key].indexOfTask(taskName) > -1) {
            ...
            _domRender__WEBPACK_IMPORTED_MODULE_2__.domRender.displayProject(projects[key]);
           }
        }
    }
}
...
const editTask = (e) => {
    ...
    if (remIndex > -1) {
        ...
        _domRender__WEBPACK_IMPORTED_MODULE_2__.domRender.displayEditForm(task);
    } else {
        for (let key of Object.keys(projects)) {
            if (projects[key].indexOfTask(taskName) > -1) {
                ...
                _domRender__WEBPACK_IMPORTED_MODULE_2__.domRender.displayEditForm(task,projects[key]);
            }
        }
    }
}
...
const createTask = (e) => {
    ...
    let dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(document.getElementById('due').value), 'M/d/yyyy');
    let priority = document.getElementById('priority').value;
    let project = document.getElementById('project').value;

    let newTask = new _constructors__WEBPACK_IMPORTED_MODULE_1__.Task(title, description, dueDate, priority, completed);
    if (project) {
        if (project in projects) {
            projects[project].addTask(newTask);
        } else {
            let newProject = new _constructors__WEBPACK_IMPORTED_MODULE_1__.Project(project, [newTask]);
            projects[newProject.name] = newProject;
            sideBarContainer.appendChild(_domContoller__WEBPACK_IMPORTED_MODULE_0__.domStuff.addProjectToDOM(newProject));
        }
    } else {
    ...
    if (project) {
        _domRender__WEBPACK_IMPORTED_MODULE_2__.domRender.displayProject(projects[project]);
    } else {
        let allTasks = [...remainingTasks];
        for (let prj in projects) {
            allTasks.push(...projects[prj].tasks)
...
let exercise = new _constructors__WEBPACK_IMPORTED_MODULE_1__.Project('exercise', []);
projects.exercise = exercise;
console.log(exercise);
exercise.addTask(new _constructors__WEBPACK_IMPORTED_MODULE_1__.Task('Go To Gym', '1 hour exercise', 'tomorrow', 'high', true));
console.log(exercise.tasks);
console.log(exercise);


sideBarContainer.appendChild(_domContoller__WEBPACK_IMPORTED_MODULE_0__.domStuff.addProjectToDOM(exercise));
