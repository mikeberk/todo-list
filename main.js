...
// static test
let taskOne = new _constructors__WEBPACK_IMPORTED_MODULE_0__.Task('Go To Gym', '1 hour exercise', '8/24/2022', 'high', 'exercise', false);
...
const deleteTask = (e) => {
    ...
    if (remIndex > -1) {
        ...
        _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayTasks(allTasks);
    } else {
        for (let key of Object.keys(projects)) {
           ...
           if (projects[key].indexOfTask(taskName) > -1) {
            ...
            _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayProject(projects[key]);
           }
        }
    }
}
...
const editTask = (e) => {
    ...
    if (remIndex > -1) {
        ...
        _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayEditForm(task);
    } else {
        for (let key of Object.keys(projects)) {
            if (projects[key].indexOfTask(taskName) > -1) {
                ...
                _domRender__WEBPACK_IMPORTED_MODULE_1__.domRender.displayEditForm(task,projects[key]);
            }
        }
    }
}
...
const createTask = (e) => {
    ...
    let dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(document.getElementById('due').value), 'yyyy-MM-dd');
